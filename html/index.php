...
<html lang="en-US">
<head>
	<script async src="https://www.googletagmanager.com/gtag/js?id=G-6W1VQ6N76D"></script>
	<script>
		window.dataLayer = window.dataLayer || [];
		function gtag(){dataLayer.push(arguments);}
		gtag(\'js\', new Date());
		gtag(\'config\', \'G-6W1VQ6N76D\');
	</script>
	<meta charset="UTF-8">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-3 col-sm-6 text-center service">
					...
					<h3>Kubernetes</h3>
					<p>We provide RKE as SaaS.</p>
				</div>
				<div class="col-md-3 col-sm-6 text-center service">
					<i class="fa fa-shopping-cart"></i>
					<h3>Mobile apps</h3>
					<p>We are building startup, stay tuned.</p>
				</div>
			</div><!-- /.row -->
		</div><!-- /.container -->
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 text-center">
					...
					<p>Life is short, so we work hard!</p>
				</div>
						...
						<div class="contact-form">
							...
							<div class="col-sm-5 your-name col-sm-offset-1">
								<div class="form-group">
									<input type="text" name="name" required="required" class="form-control" id="contact-name" placeholder="Enter your name...">
								</div>
							</div>
							<div class="col-sm-5 your-email">
								<div class="form-group">
									<input type="email" name="email" class="form-control" required="required" id="contact-email" placeholder="Enter your email...">
								</div>
							</div>
							<div class="col-sm-10 your-message col-sm-offset-1">
								<div class="form-group">
									<textarea name="message" id="contact-message" required="required" class="form-control" rows="10" placeholder="Enter your message..."></textarea>
								</div>
								<div class="form-group">
									<button type="submit" id="contact-button" name="submit" class="btn btn-primary btn-lg submit-button" >Submit</button>
								</div>
							</div>
                            </div>     
						</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-12 text-center">
					<p>&copy; 2022 <strong></strong>. All Rights Reserved. Designed by <strong><a href="https://templatestock.co" target="_blank">Template Stock</a></strong></p>
				</div>
			</div>
		</div>
	</footer><!-- /.footer -->
